...
trait persian_date
{
	...
	static $persian_month_names=array(
	'01'=>'&#1601;&#1585;&#1608;&#1585;&#1583;&#1740;&#1606;',
	'02'=>'&#1575;&#1585;&#1583;&#1740;&#1576;&#1607;&#1588;&#1578;',
	'03'=>'&#1582;&#1585;&#1583;&#1575;&#1583;',
	'04'=>'&#1578;&#1740;&#1585;',
	...
	static $persian_day_names=array(
	'6'=>'&#1588;&#1606;&#1576;&#1607;',
	'0'=>'&#1740;&#1705;&#1588;&#1606;&#1576;&#1607;',
	'1'=>'&#1583;&#1608;&#1588;&#1606;&#1576;&#1607;',
	'2'=>'&#1587;&#1607; &#1588;&#1606;&#1576;&#1607;',
	...
	protected static function gregorian_to_persian($g_y, $g_m, $g_d)
	{
	...
	protected static function persian_to_gregorian($j_y, $j_m, $j_d)
	{
		$g_days_in_month = array(31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31);
		$j_days_in_month = array(31, 31, 31, 31, 31, 31, 30, 30, 30, 30, 30, 29);
		$jy = $j_y-979;
	...
	protected static function to_date($g_date,$input)
	{
		...
		$persian_date=static::gregorian_to_persian($g_year,$g_month,$g_day);
		if($input=='Y') return $persian_date[0];
		if($input=='y') return substr($persian_date[0],-2);
		if($input=='M') return static::persian_month_names[$persian_date[1]];
		if($input=='m') return $persian_date[1];
		if($input=='D') return static::persian_day_names[date('w')];
		...
		if($input=='compelete') 
		{
			$persian_d=$persian_date[2];
			if($persian_d{0}=='0') $persian_d=substr($persian_d,1);
				return static::persian_day_names[date('w')].' '.$persian_d.' '.static::persian_month_names[$persian_date[1]].' '.$persian_date[0]; 
		}
	}
	
	protected static function date($input)
	{
		return static::to_date(date('Y').date('m').date('d'),$input);		
	}
	
	protected static function date_to($j_date)
	{
		...
		$gregorian_date=static::persian_to_gregorian($j_year,$j_month,$j_day);
		return $gregorian_date[0].'-'.$gregorian_date[1].'-'.$gregorian_date[2];
	}
	
	protected static function sec_to_day($sec)
	{
