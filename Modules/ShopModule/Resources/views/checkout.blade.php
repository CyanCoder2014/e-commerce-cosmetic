                                    ...
                                    <div class="panel-body">
                                        <fieldset id="address" class="required">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" id="input-payment-company" placeholder="شرکت" value="" name="company" type="text">
                                            </div>
                                            <div class="form-group required">
                                                <label for="input-payment-address-1" class="control-label">آدرس 1</label>
                                                <input class="form-control" id="input-payment-address-1" placeholder="آدرس 1" value="" name="address_1" type="text">
                                            </div>
                                            <div class="form-group">
                                                <label for="input-payment-address-2" class="control-label">آدرس 2</label>
                                                <input class="form-control" id="input-payment-address-2" placeholder="آدرس 2" value="" name="address_2" type="text">
                                            </div>
                                            <div class="form-group required">
                                                <label for="input-payment-city" class="control-label">شهر</label>
                                                <input class="form-control" id="input-payment-city" placeholder="شهر" value="" name="city" type="text">
                                            </div>
                                            <div class="form-group required">
                                                <label for="input-payment-postcode" class="control-label">کد پستی</label>
                                                <input class="form-control" id="input-payment-postcode" placeholder="کد پستی" value="" name="postcode" type="text">
                                            </div>
                                            <div class="form-group required">
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input checked="checked" value="1" name="shipping_address" type="checkbox">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="radio">
                                                    <label>
                                                        <input checked="checked" name="ارسال رایگان" type="radio">
                                                        رایگان - 0 تومان</label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input name="Flat Shipping Rate" type="radio">
                                                        هزینه ی ثابت - 8000 تومان</label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input name="Per Item Shipping Rate" type="radio">
                          ...
                          <input class="btn btn-primary" data-loading-text="بارگذاری ..." id="button-voucher" value="اعمال کارت هدیه" type="submit">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        ...
                                                        @foreach(Cart::content() as $item)
                                                            <tr>
                                                                <td class="text-center"><a href="product.html"><img src="{{asset($item->name['pic'])}}" alt="{{$item->name['name']}}" title="{{$item->name['name']}}" class="img-thumbnail"></a></td>
                                                                <td class="text-left"><a href="product.html">{{$item->name['name']}}</a></td>
                                                                <td class="text-left"><div class="input-group btn-block" style="max-width: 200px;">
                                                                        <form method="get" action="{{route('cart.updatePage')}}">
                                                                            <input name="qty" value="{{$item->qty}}" size="1" class="form-control" type="text">
                                                                            ...
                                                                            <button type="button" id="{{$item->rowId}}" data-toggle="tooltip" title="" class="btn btn-danger cart-delete" onclick="location.reload()" data-original-title="حذف"><i class="fa fa-times-circle"></i></button>
                                                                        </span>
                                                                        </form>
                                                                    </div></td>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="panel panel-default">
                                            ...
                                            <form method="post" action="{{route('shop.invoice')}}">
                                                {{csrf_field()}}
                                                <div class="panel-body">
                                                    ...
                                                    <div class="buttons">
                                                        <div class="pull-right">
                                                            <input class="btn btn-primary" id="button-confirm" value="تایید سفارش" type="submit">
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
