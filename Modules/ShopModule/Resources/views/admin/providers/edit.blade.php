                                                ...
                                                <div class="tile-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10 row">
                                                            <input id="Image" class="form-control" type="text" name="logo" value="{{$provider->logo}}">
                                                            <a data-input="Image" data-preview="holder"  class="lfm btn btn-primary">
                                                                <i class="fa fa-picture-o"></i>انتخاب
                                                            </a>
                                                            <img id="holder" style="margin-top:15px;max-height:100px;" @if($provider->logo) src="{{$provider->logo}}" @endif>
                                                        </div>
