                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover table-custom"
                                        ...
                                        <tr>
                                            ...
                                            <th style="text-align: center">&nbsp;ادرس</th>
                                            <th style="text-align: center">  شماره</th>
                                        ...
                                        @foreach($providers as $provider)
                                            <tr class="odd gradeX">
                                                ...
                                                <th style="text-align: center; font-weight: 100">{{ $provider->address }}</th>
                                                <th style="text-align: center; font-weight: 100">{{ $provider->phone }}</th>
