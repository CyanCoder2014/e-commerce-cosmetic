...
@section('content')
                                                        ...
                                                        <div class="tab-content">
                                                            <div class="tab-pane fade in active" id="tab1default">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="name_fa" placeholder="نام" name="name_fa" value="{{old('name_fa')}}">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                            ...
                                                            <div class="tab-pane fade" id="tab2default">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="name_en" placeholder="name" required name="name_en" value="{{old('name_en')}}">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                            ...
                                                            <div class="tab-pane fade" id="tab3default">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="name_ar" placeholder="name" required name="name_ar" value="{{old('name_ar')}}">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        window.onload = function() {
            ...
            var fieldHTML ='<tr>'+
                '<td> <select  type="text" name="detail_price[]" class="form-control"><option value="1">جزئیات فنی</option><option value="2">جزئیات ظاهری</option></select>' +
                ' </td>'+
