...
@section('content')
    ...
    <section id="content">
        ...
        <div class="page page-shop-single-product">
            ...
            <div class="pageheader">
                ...
                <div class="page-bar">
                    ...
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="{{ route('brands.index') }}">مدیریت برندها</a>
                        </li>
                        <li>
                            <a href="">افزودن برند</a>
                        </li>
                    </ul>
            ...
            <form id="productForm" class="form-horizontal ng-pristine ng-valid" role="form" method="post" action="{{route('brands.add')}}">
                {{ csrf_field() }}

                <div class="add-nav">
                    <div class="nav-heading">
                        <h3>برند  <strong class="text-greensea">جدید:</strong></h3>
                                        ...
                                        <section class="tile">
                                            ...
                                            <div class="tile-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="founder" placeholder="موسس" name="founder" value="{{old('founder')}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="country" placeholder="کشور" name="country" value="{{old('country')}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="year" placeholder="نام" name="year" value="{{old('year')}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="variety" placeholder="تنوع محصول" name="variety" value="{{old('variety')}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="site" placeholder="وب سایت" name="site" value="{{old('site')}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="company" placeholder="شرکت " name="company" value="{{old('company')}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select  class="form-control" id="classification" name="classification">
                                                                <option value="1">لوکس ++</option >
                                                                <option value="2">لوکس +</option >
                                                                <option value="3">لوکس</option >
                                                                <option value="4">معمولی</option >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                                        <textarea class="form-control" id="description" placeholder="Short Item Description" title="details" name="description">{{old('description')}}</textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 row">
                                                        <input id="sda" class="form-control" type="text" name="Image" value="{{old('Image')}}">
                                                        <a data-input="sda" data-preview="holder"  class="lfm btn btn-primary">
                                                            <i class="fa fa-picture-o"></i>انتخاب
                                                        </a>
                                                        <img id="holder" style="margin-top:15px;max-height:100px;" @if(old('Image')) src="{{old('Image')}}" @endif>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 row">
                                                        <input id="logo" class="form-control" type="text" name="logo" value="{{old('logo')}}">
                                                        <a data-input="logo" data-preview="holder-2"  class="lfm btn btn-primary">
                                                            <i class="fa fa-picture-o"></i>انتخاب
                                                        </a>
                                                        <img id="holder-2" style="margin-top:15px;max-height:100px;" @if(old('logo')) src="{{old('logo')}}" @endif>
                                                    </div>
