            ...
            <div class="pagecontent">
                ...
                <div class="add-nav">
                    <div class="nav-heading">
                        <h3>جزئیات سفارش : <strong class="text-greensea">#{{ $order->id }}</strong></h3>
                                        ...
                                        <section class="tile time-simple">
                                            ...
                                            <div class="tile-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <!-- col -->
                                                    <div class="col-md-9">
                                                        <p class="text-default lt">ایجاد شده: {!!  to_jalali($order->created_at)!!}</p>
                                                        ...
                                                        @elseif($order->state == 1)
                                                            <h3 class="text-uppercase text-warning mt-0 mb-20">درگاه پرداخت</h3>
                                                ...
                                                <div class="row b-t pt-20">
                                                    ...
                                                    <div class="col-md-3 b-r">
                                                        ...
                                                        <ul class="list-unstyled text-default lt mb-20">
                                                            <li><strong>شماره:</strong> <a href="javascript:;">{{ $order->id }}</a></li>
                                                            <li>{!!  to_jalali($order->created_at)!!}</li>
                                                            <li>{{ $user->name }}</li>
                                                        </ul>
                                                    </div>
                                                    <!-- /col -->
                                        ...
                                        <section class="tile tile-simple bg-tr-black lter">
                                            ...
                                            <div class="tile-body">
                                                ...
                                                <ul class="list-unstyled">
                                                    ...
                                                    -->
                                                    <li><strong class="inline-block w-sm">کل:</strong> <h3 class="inline-block text-success">{{$order->amount}}</h3></li>
                                                </ul>
