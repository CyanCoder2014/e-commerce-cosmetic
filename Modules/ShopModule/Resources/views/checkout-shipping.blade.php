                ...
                <div class="row">
                    ...
                    <div id="content" class="col-sm-12" style="text-align: right">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="row">
                                    <form method="post" action="{{route('shop.comfirmation')}}">
                                        {{csrf_field()}}
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-left">سیستم حمل و نقل</td>
                                                        ...
                                                        @foreach($order_items as $item)
                                                            <tr>
                                                                ...
                                                                <td class="text-left"><div class="input-group btn-block" style="max-width: 200px;">
                                                                        <select name="shipping[{{$item->id}}]" id="">
                                                                            <?php $shipping =$item->product->available_shippings($address_record) ?>
                                                                            @if($shipping->count() > 0)
                                                                            @foreach($shipping->get() as $shipping)
                                                        ...
                                                        <tfoot>
                                                        <tr>
                                                            <td class="text-right" colspan="2"><strong>جمع کل:</strong></td>
                                                            <td class="text-right">{{$cart->subtotal}} تومان</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-right" colspan="2"><strong>کسر هدیه:</strong></td>
                                                            <td class="text-right">{{$cart->discount}} تومان</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-right" colspan="2"><strong>مالیات:</strong></td>
                                                            <td class="text-right">{{$cart->tax}} تومان</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-right" colspan="2"><strong>کل :</strong></td>
                                                ...
                                                <div class="panel-body">
                                                    <div class="buttons">
                                                        <div class="pull-right">
                                                            <input class="btn btn-primary" id="button-confirm" value="مرحله بعد" type="submit">
                                                        </div>
                                                    </div>
                                                </div>
                                        </div>
