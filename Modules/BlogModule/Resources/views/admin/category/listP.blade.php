                                                                ...
                                                                <div id="collapse{{$category->id}}"
                                                                    ...
                                                                    <div class="panel-body">
                                                                        ...
                                                                        <form name="_token" method="POST"
                                                                              ...
                                                                              action="<?= Url('/admin/category3/update/' . $category->id); ?>">
                                                                            {{ csrf_field() }}
                                                                            ...
                                                                            <div class="col-lg-2 col-md-2  col-sm-12 col-xs12 form-group">
                                                                                ...
                                                                                <input style="" class="form-control" name="title_e" placeholder="انگلیسی"
                                                                                       value="{{$category->title_e}}">
                                                                            </div>
                                                                            <br><br><br><br>
                                                                            <div class="col-md-12">
                                                                                <textarea required title="text" name="intro" id="editor{{$category->id}}" rows="10" cols="80" >{!! $category->intro !!}</textarea><br>
                                                                            </div>
                                                                            <br><br><br><br>

                                                                            <a type="submit" onclick="return confirm('آیا از حذف دسته بندی مطمئن هستید؟');"
                                                                               href="<?= Url('/admin/category3/destroy/' . $category->id); ?>"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form name="_token" method="POST"
                          enctype="multipart/form-data"
                          action="<?= Url('/admin/category3/add') ?>">
                        {{ csrf_field() }}
