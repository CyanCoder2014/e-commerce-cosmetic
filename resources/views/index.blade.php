        ...
        <div class="carousel-inner" role="listbox">
            ...
            @foreach($sliderFirst as $key => $sliderFirst)
                <div class="carousel-item @if($key===0) active @endif">
                    <!--Mask color-->
                    <div class="view">
                        @if($sliderFirst->video === null)
                            <div class="w-100 heightScreen bg-img"
                                 style="background-image: url('{{$sliderFirst->image}}')"></div>
                            <div class="mask rgba-black-light"></div>

                        @else
                            <video class="heightScreen w-100" loop autoplay muted>
                                <source src="{{$sliderFirst->video}}" type="video/mp4">
                                <source src="{{$sliderFirst->video}}" type="video/ogg">
