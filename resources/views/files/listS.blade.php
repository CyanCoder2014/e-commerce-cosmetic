                    ...
                    <div class="col-md-2 col-sm-6">
                        <div data-toggle="modal" data-target="#file-{{$file->id}}" class="square-services"
                            ...
                            <div class="square-infos">
                                ...
                                @if(Auth::check())
                                <a target="_blank" href="<?= Url('/files/' . $file->link); ?>" title=""><i
                    ...
                    <div class="col-md-2 col-sm-6">
                        <div data-toggle="modal" data-target="#file-{{$tag->file->first()->id}}" class="square-services"
                            ...
                            <div class="square-infos">
                                ...
                                @if(Auth::check())
                                    <a target="_blank" href="<?= Url('/files/' . $tag->file->first()->link); ?>" title=""><i
                                                class="fa fa-cloud-download"></i></a>
                                @endif
                            </div>
                        </div><!-- square services -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <hr>
                        <span> توسط:  <a title="{{$file->user->name.' '.$file->user->family}}" target="_blank" href="<?= Url('home/profile/show/137-'.$file->user->id.'-42-'.$file->user->username); ?>">{!! $file->user->username !!}</a> </span>
                        <hr>
                        <span> برچسب ها:
                        ...
                        <div class="modal-footer">
                            @if(Auth::check())
                            <a target="_blank" href="<?= Url('/files/' . $file->link); ?>" type="button" name="_token"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <hr>
                        <span> توسط:  <a title="{{$tag->file->first()->user->name.' '.$tag->file->first()->user->family}}" target="_blank" href="<?= Url('home/profile/show/137-'.$tag->file->first()->user->id.'-42-'.$tag->file->first()->user->username); ?>">{!! $tag->file->first()->user->username !!}</a> </span>
                        <hr>
                        <span> برچسب ها:
                        ...
                        <div class="modal-footer">
                            @if(Auth::check())
                                <a target="_blank" href="<?= Url('/files/' . $tag->file->first()->link); ?>" type="button" name="_token"
                                   class="btn btn-success"><i class="fa fa-cloud-download"></i>
                                </a>
                            @endif
                            <button type="button" class="btn btn-default"
