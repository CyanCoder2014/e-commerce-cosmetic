                                                                    ...
                                                                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <span class="input-group-btn">
                                                                                     <a id="" data-input="image{{ $user->id }}" data-preview="thumbnail{{ $user->id }}" class="btn btn-primary lfm">
                                                                                       <i class="fa fa-picture-o"></i> انتخاب
                                                                                     </a>
                                                                                </span>
                                                                            <input id="image{{ $user->id }}" class="form-control" type="text" name="image" value="{{ $user->image }}">
                                                                            <img id="thumbnail{{ $user->id }}" style="margin-top:15px;max-height:100px;"  src="{{ $user->image }}" >
                                                                        </div>
                                                                        @if($user->profile !== null)
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label> آدرس </label>
                                                                                <input disabled type="text" class="form-control"
                                                                                       name="introduce" value="{{$user->profile->address}}">
                                                                            </div>
                                                                        @endif
                                                                        <br>
                                                                        <label>نقش ها:</label>
                        ...
                        <div class="row">
                            <div>
                                ...
                                <div class="input-group">
                                    <label for="image">عکس</label>
                                    <span class="input-group-btn">
                                         <a id="" data-input="image-user" data-preview="thumbnail-user" class="btn btn-primary lfm">
                                           <i class="fa fa-picture-o"></i> انتخاب
                                         </a>
                                    </span>
                                    <input id="image-user" class="form-control" type="text" name="image" value="">
                                    <img id="thumbnail-user" style="margin-top:15px;max-height:100px;"  src="" >
                                </div>
