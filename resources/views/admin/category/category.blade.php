            ...
            <div class="pageheader">
                ...
                <div class="page-bar">
                    ...
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="index.html">مدیریت مطالب</a>
                        </li>
                    </ul>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="widget white with-padding">
                                <div class="service">
                                    ...
                                    <p>یک سطحی</p>
                                    <a href="<?= Url('/home/admin/list/3'); ?>" title="" class="c-btn medium blue-bg">
                                        تنظیمات</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <div class="widget white with-padding">
                                <div class="service">
                                    ...
                                    <p>دو سطحی</p>
                                    <a href="<?= Url('/home/admin/list/2'); ?>" title="" class="c-btn medium red-bg">
                                        تنظیمات</a>
                                </div>
                            </div>
                        </div>
