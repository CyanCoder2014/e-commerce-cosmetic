                                    ...
                                    <table class="table table-striped table-bordered table-hover"
                                        ...
                                        @foreach($contents as $content)
                                            <tr class="odd gradeX">
                                                ...
                                                <th style="text-align: center; font-weight: 100">{{ $content->grade }}</th>
                                               <th style="text-align: center; font-weight: 100"><a data-toggle="modal" data-target=".edit-page-{{$content->id}}" class="btn btn-warning "><i class="fa fa-edit"></i></a></th>
                                                <th style="text-align: center; font-weight: 100">
                                                    <form method="POST" action="{{ route('Qcat.delete',['id' =>$content->id]) }}" id="'delete-{{$content->id}}'">
                ...
                <form name="_token" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-12" style="margin-bottom: 30px">
                            <div class="input-group"><p style="float: right">  عنوان دسته بندی سوال</p>
                                <input required name="title" type="text" value="{{old('title')}}"  class="form-control">
                            </div>
                            <div class="input-group"><p style="float: right">  نمره</p>
                                <input required name="grade" type="text" value="{{old('grade')}}"  class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="input-group"><h3 style="float: right">گزینه ها</h3></div>
                            ...
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea type="text" name="option[content][]"  class="form-control">
                                        </textarea>
                                    </td>
                                    <td>
                                        <input type="text" name="option[grade][]"  class="form-control">
                                    </td>
                                    <td>
        ...
        <div class="modal fade edit-page-{{$content->id}}" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form name="_token" method="POST" enctype="multipart/form-data"
                          action="{{route('Qcat.update',['id'=>$content->id])}}">
                        {{ csrf_field() }}
                        {{ method_field('PATCH') }}
                        <div class="modal-body">
                            ...
                            <div class="col-md-12" style="margin-bottom: 30px">
                                ...
                                <div class="input-group"><p style="float: right">  نمره</p>
                                    <input required name="grade" type="text" value="{{$content->grade}}" class="form-control">
                                </div>
                            </div>
                            ...
                            <table class="table-striped " style="width:100%">
                                ...
                                <td>
                                    <input type="text" name="option[grade][]" value="{{$option['grade']}}" class="form-control">
                                </td>
                                <td>
                                    <input type="text" name="option[label][]" value="{{$option['label']}}" class="form-control">
                                </td>
                                <td>
                                <a href="javascript:void(0);" class="remove_button" title="Remove field"><span class="glyphicon glyphicon-remove"></span></a>
                                </td>
    ...
    @endforeach
        <script type="text/javascript">
            ...
            window.onload = function() {
                ...
                var fieldHTML ='<tr><td><input type="text" name="option[title][]"  class="form-control"><td><textarea type="text" name="option[content][]"  class="form-control"> </textarea></td><td><input type="text" name="option[grade][]"  class="form-control"></td><td><input type="text" name="option[label][]"  class="form-control"> </td><td><a href="javascript:void(0);" class="remove_button" title="Remove field"><span class="glyphicon glyphicon-remove"></span></a> </td></tr>'; //New input field html
