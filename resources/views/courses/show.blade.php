            ...
            <div class="widget blank">
                    <div class="tweet-widget">
                        ...
                        <div class="twitter-profile">
                            ...
                            <h3><a target="_blank" href="<?= Url('home/profile/show/137-'.$course->user->id.'-42-'.$course->user->username); ?>">{{$course->user->username}} </a><i title="Verified" class="fa fa-check skyblue-bg" data-toggle="tooltip" data-placement="top"></i></h3>
                    ...
                    <section class="center slider">
                        ...
                        <div>
                            ...
                            <div style="max-height: 550px;overflow: hidden">
                                    ...
                                    @if($slide->effect == '1')
                                        <img src="<?= Url($slide->description); ?>">
                                    @else
                                        <img src="<?= Url('/course-slide/'.$slide->description); ?>">
                                    @endif
                            </div>
                            <br>  <p>{{$slide->image}}</p><br>
                        </div>
                        @endforeach
                    </section>
                                    ...
                                    <span>
                                      ...
                                      <div class="timeline-detail">
                                          <div class="timeline-head">
                                              <h3>&nbsp; <a target="_blank" href="<?= Url('home/profile/show/137-'.$course->user->id.'-42-'.$course->user->username); ?>" id="popoverone" data-content="
                                           @if($course->user->profile !== null)
                                          ...
                                          <div class="timeline-content">
                                              ...
                                              @if($course->image_b !== 'null' && $course->image_b !== 'file' && $course->image_b !== '')
                                                  <div id="file-1234-{{$course->id}}" style=" max-height: 400px;overflow: hidden">
                                                      <a target="_blank" href="<?= Url('/post-files/'.$course->image_b); ?>" type="button" name="_token"
