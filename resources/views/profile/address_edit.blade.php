...
@section('profile_content')
    ...
    <div class="row">
        ...
        <div id="content" class="col-sm-12">
            <h1 class="title">ویرایش آدرس شما</h1>
                ...
                <form method="post">
                    ...
                    <fieldset id="address">
                        ...
                        <div class="form-group">
                            <label for="input-company" class="col-sm-2 control-label">نام</label>
                            <div class="col-sm-10">
                                <input class="form-control" id="input-company" placeholder="نام" value="{{$address->firstname}}" name="firstname" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="input-company" class="col-sm-2 control-label">نام خانوادگی</label>
                            <div class="col-sm-10">
                                <input class="form-control" id="input-company" placeholder="نام خانوادگی" value="{{$address->lastname}}" name="lastname" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="input-company" class="col-sm-2 control-label">شرکت</label>
                            <div class="col-sm-10">
                                <input class="form-control" id="input-company" placeholder="شرکت" value="{{$address->company}}" name="company" type="text">
                            </div>
                        </div>
                        <div class="form-group required">
                            <label for="input-address-1" class="col-sm-2 control-label">آدرس</label>
                            <div class="col-sm-10">
                                <input class="form-control" id="input-address-1" placeholder="آدرس" value="{{$address->address}}" name="address" type="text">
                            </div>
                        </div>
                        <div class="form-group required">
                            <label for="input-postcode" class="col-sm-2 control-label">کد پستی</label>
                            <div class="col-sm-10">
                                <input class="form-control" id="input-postcode" placeholder="کد پستی" value="{{$address->postcode}}" name="postcode" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="input-company" class="col-sm-2 control-label">تلفن</label>
                            <div class="col-sm-10">
                                <input class="form-control" id="input-company" placeholder="تلفن" value="{{$address->phone}}" name="phone" type="text">
                            </div>
                        </div>
                        <div class="form-group required">
                        ...
                        <div class="form-group required">
                            ...
                            <div class="col-sm-10">
                                <select id="city" class="form-control" name="city_id" data-selected="{{$address->city_id}}">
                                </select>
                            </div>
                        </div>
                    </fieldset>
