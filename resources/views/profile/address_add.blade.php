                ...
                <form method="post">
                    ...
                    <fieldset id="address">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" id="input-company" placeholder="نام خانوادگی" value="{{old('lastname')}}" name="lastname" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="input-company" class="col-sm-2 control-label">شرکت</label>
                            <div class="col-sm-10">
                                <input class="form-control" id="input-company" placeholder="شرکت" value="{{old('company')}}" name="company" type="text">
                            </div>
                        </div>
