                ...
                <div class="row">
                    <div class="col-md-3 column">
                        <div class="heading-profile">
                            ...
                            <span> ایجاد توسط: <a  target="_blank" href="<?= Url('home/profile/show/137-'.$posts->first()->forum->user->id.'-42-'.$posts->first()->forum->user->username); ?>" id="popoverone"  data-content="
                            ...
                            <ul class="your-emails"  id="inbox-mail-list">
                                ...
                                @foreach($requests as $request)
                                    <li class="email unread">
                                        <a target="_blank" href="<?= Url('home/profile/show/137-'.$request->id.'-42-'.$request->username); ?>"  id="{{$request->id}}" style="margin-right: 30px;color: #1b6d85"  class="inbox-msg"><span class="blue-bg">{{$request->username}}</span>      </a>
